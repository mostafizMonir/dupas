    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          ...
          <a class="collapse-item active" href="updateFaculty.php"><i class="fas fa-user-edit"></i>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4 text-center">Update faculty informations.</p>
                ...
                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0" style="font-size: 13px;">
                  ...
                  <tbody>
...

                      {
                        ...
                        <input type='hidden' id='teacherID' name='tid' value='".$row['teacher_id']."'>
                        <td><select id='desig' name='designation' class='form-control bg-white' style='font-size:13px;'>
                        <option value='".$row['designation']."'hidden selected>".$row['designation']."</option>
                        ...
                        <td><input name='phone' type='text' value='".$row['phone'] ."'></td>
